...
public class DataImportService : IDataImportService
{
    ...
    public DataImportService(ArtDbContext context, IConfiguration config)
    {
        _context = context;
        var basePath = config["StorageSettings:PythonProjectImagesPath"];
        _jsonPath = Path.Combine(basePath, "metadata.json");
    }
